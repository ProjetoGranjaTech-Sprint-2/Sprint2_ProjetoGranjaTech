function calcular() {
    ...
    div_html.innerHTML = `
    <span> 
        De suas <b style="color: #ffd890;"> ${galinhas} </b> galinhas, em média <b style="color: #ffd890;"> ${(galinhasPerdidas).toFixed(0)}%</b> delas morrem por falta de monitoramento de regulação da temperatura e umidade, com <b style="color: #ffd890;"> ${galinhasMortas} </b> galinhas a menos, devido a perda de <b style="color: #ffd890;">${(ovoPorGalinhaPerdido).toFixed(0)} </b> ovos, isso faz você deixar de ganhar:
    </span>
